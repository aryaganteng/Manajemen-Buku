        ...
        <div className="container-mt3">
            ...
            <div id="formTambah">
                ...
                <form className="form-row" onSubmit={submitAdd}>
                    ...
                    <div className="col-2">
                        <input type="submit" className="ml-5" value="simpan" />
                    </div>
                </form>
            </div>
            )}
                    ...
                    <tbody>
                        {bookList.map((book,index) => (
                            <tr key={index}>
                                ...
                                <td> {book.stok} </td>
                                <td>
                                    <button className="btn btn-info" style={{margin: "10px"}} onClick={() => showEdit(book)}>Edit</button>
                                    <button className="btn btn-danger pl-3" onClick={() => deleteBook(book)}>Hapus</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
